...
//$r = mysql_query("SELECT `vat` from tax ");
...
<ul id="navigation"> 
	...
	<li class="active"><a href="createquotation.php">+ Create Quotation <span class="icon-users"></span></a></li>
...
<div id="content" class="ninecol last">   
  ...
  <div class="panel"> 
  <div class="title"> 
  <h4>Create Quotation</h4> <div class="collapse">collapse</div> </div>  <div class="content"> 
  <br/>
 

<form action="quotation_print.php" method="post" enctype="multipart/form-data">

Customer:<INPUT type="text"  name="cname" /> <br/>
	...
	<br/>
		...
		<TR>
			...
			<?php //echo $_SESSION['tax1']; ?><?php //echo $_SESSION['tax2']; ?>
		...
		<!--Pay Now: <input type="text" name="paid" /><br/>-->
