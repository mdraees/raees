...
$result = mysql_query("select username from user")  or die(mysql_error()); 
?>
...
<div id="content" class="ninecol last">   
 ...
 <br/>
<select name="user">
<option selected="selected">Select user:</option><br/> <?php 
...
<br/>
<br/>
<input type="submit" name="submit"  value="SUBMIT" class="button-green"/>
</form>
</fieldset>
