...
<title>Kriz Invoice - My Income</title>   
...
$sql1=mysql_query("SELECT  `invoice_id` ,  `Amount` ,  `time`  FROM  `invoices` where `time` between '$from' and '$to' ") or die(mysql_error());
...
$sql2=mysql_query("SELECT  sum(`Amount`) as total FROM  `invoices` where `time` between '$from' and '$to' ") or die(mysql_error());
