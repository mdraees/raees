...
<div id="content" class="ninecol last">   
  ...
  <div class="panel"> 
  <div class="title"> 
  <h4>View Stock</h4></div>  <div class="content"> 
  <!-- ## Panel Content  -->  
  <form action="#">
			<fieldset>
				<input type="text" name="search" value="" id="id_search" placeholder="Search" size="32" maxlength="20"/> <span class="loading">Loading...</span>
			</fieldset>
		</form>	
