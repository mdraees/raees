...
$SQL = $SQL . " (why, amount, date,out_id) VALUES ";
$SQL = $SQL . " ('$why', '$amount','$date','$outlet') ";
...
<title>Kriz Invoice - Add Expense</title>   
...
<ul id="navigation"> 
	...
	<li  class="active"><a href="addExpense.php">+ Add Expense <span class="icon-forms"></span></a></li> 
	<li><a href="addStock.php">+ Add Stock <span class="icon-forms"></span></a></li> 
	<li><a href="viewStock.php">+ View Stock <span class="icon-forms"></span></a></li> 
</ul> 
</div>  
...
<div id="content" class="ninecol last">   
  ...
  <div class="panel"> 
  <div class="title"> 
  <h4>Add Expense</h4> <div class="collapse">collapse</div> </div>  <div class="content"> 
  <!-- ## Panel Content  -->
  <?php if ($f==1)
{ echo '<div class="notice success"> <span><strong>Success:</strong>Expense Added</span> </div>  ';}
else if ($f==2)
...
<label>Expense Description</label> <textarea rows="5" cols="20" name="why" placeholder="Why"></textarea></div>  
<div class="group fixed"> <label>Amount Spent </label> <input title="Enter Amount" required="required" placeholder="Amount Spent" name="amount" type="text" id="amount" value="" size="32" maxlength="20" autocomplete="off"  /></div>  
<div class="group fixed"> <label>Date</label> <input title="Enter Date"  id="from" type="text" name="date" placeholder="YYYY-MM-DD" /></div>  
    <br/>
	<input type="submit" class="button-red" name="Submit" value="Add Expense" />
