...
$sql1=mysql_query("SELECT  `why` ,  `Amount` ,  `date`  FROM  `expense` where `date` between '$from' and '$to' and out_id='$outlet' ") or die(mysql_error());
...
$sql2=mysql_query("SELECT  sum(`Amount`) as total FROM  `expense` where `date` between '$from' and '$to' and out_id='$outlet' ") or die(mysql_error());
